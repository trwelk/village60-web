...
export type VillageComboboxOption = {
  value: string;
  label: string;
  hint?: string;
};
...
/**
 * Typable combobox for picking from a list. Filters options by case-insensitive
...
export function VillageCombobox({
  ...
  useLayoutEffect(() => {
    ...
    const el = listRef.current?.querySelector<HTMLElement>(
      `[data-combobox-option-index="${highlight}"]`,
    );
