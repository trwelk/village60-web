...
import { HomeAccountPaymentsLedgerSection } from "./HomeAccountPaymentsLedgerSection";

type HomeAccountPaymentsPageProps = {
...
export default async function HomeAccountPaymentsPage({
  searchParams,
}: HomeAccountPaymentsPageProps) {
  ...
  return (
    <main className="flex flex-col gap-7 text-ink">
      <HomeAccountPaymentsLedgerSection
        homes={homeOptions}
